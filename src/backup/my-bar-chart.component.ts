...
show : boolean = false
  ...
  public barChartOptions: ChartOptions = {
    ...
    public barChartLabels: Label[] = this.array.map(e => e["Date"])
    ...
    public barChartColor1=[
      {
        backgroundColor: 'green' 
      },
    ];
    public barChartColor2=[
      {
    ...
    public barChartData: ChartDataSets[] = [
      ...
      { data: this.array.map(e => e["Deaths"]), label: 'Death'},
    ...
    public barChartData1: ChartDataSets[] = [
      ...
      { data: this.array.map(e => e["Confirmed"]), label: 'Confirmed' },
      
    ];
    public barChartData2: ChartDataSets[] = [
  
     
      { data: this.array.map(e => e["Recovered"]), label: 'Recovered' },
